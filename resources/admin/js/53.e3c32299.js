    ...
    [53], {
        56053: function(O, Q, i) {
            ...
            var $ = function() {
                    ...
                    return i("a-form", {
                    ...
                    })], 1)], 1), i("a-form-item", [i("a-space", [i("a-select", {
                        staticStyle: {
                            width: "100px"
                        },
                        attrs: {
                    ...
                    }, [O._v("200 行")]), i("a-select-option", {
                        attrs: {
                            value: "500"
                        }
                    }, [O._v("500 行")]), i("a-select-option", {
                        attrs: {
                            value: "800"
                        }
                    }, [O._v("800 行")]), i("a-select-option", {
                        attrs: {
                            value: "1000"
                        }
                    }, [O._v("1000 行")])], 1), i("a-button", {
                        attrs: {
                            loading: O.loading,
                            type: "primary"
                        },
                        on: {
                            click: function(Q) {
                                return O.handleLoadLogsLines()
                            }
                        }
                    }, [O._v("刷新")]), i("a-button", {
                        attrs: {
                            loading: O.downloading,
                            type: "dashed"
                        },
                        on: {
                            click: function(Q) {
                                return O.handleDownloadLogFile()
                            }
                        }
                    }, [O._v("下载")])], 1)], 1)], 1)
                },
                a = [],
                P = (i(31875), i(29888), i(45107), i(42164), i(20838), i(1976)),
                e = i(8192),
                t = i(17918);
            const n = {
                    __proto__: null,
                ...
                X = e.WQ.deserialize({
                    ...
                    maxTerm: 269,
                    nodeProps: [
                        [t.md.group, -26, 4, 46, 75, 76, 81, 86, 91, 143, 145, 148, 149, 151, 154, 156, 159, 161, 163, 165, 170, 172, 174, 176, 178, 179, 181, 189, "Statement", -24, 6, 13, 14, 15, 16, 17, 18, 19, 20, 21, 38, 39, 40, 98, 99, 101, 102, 105, 116, 118, 120, 123, 125, 128, "Expression", -7, 22, 23, 24, 25, 26, 28, 33, "Type"],
                        [t.md.openedBy, 10, "(", 43, "{"],
                        [t.md.closedBy, 11, ")", 44, "}"]
                    ],
                    skippedNodes: [0, 1, 2],
            ...
            const p = o.qp.define({
                parser: X.configure({
                    props: [o.uj.add({
                        ...
                        LabeledStatement: o.ze,
                        SwitchBlock: O => {
                            let Q = O.textAfter,
                                i = /^\s*\}/.test(Q),
                                $ = /^\s*(case|default)\b/.test(Q);
                        ...
                        ["Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody ConstructorBody InterfaceBody ArrayInitializer"]: o.Dv,
                        BlockComment(O) {
                            return {
                                from: O.from + 2,
                                to: O.to - 2
                        ...
                        "class interface extends implements module package import enum": r.pJ.definitionKeyword,
            ...
            var T = i(32609),
                ...
                s = {
                    ...
                    methods: {
                        handleLoadLogsLines: function() {
                            var O = this;
                            this.loading = !0, Y.Z.getLogFile(this.logLines).then((function(Q) {
                                O.logContent = Q.data, O.$nextTick((function() {
                                    O.$refs.editor.handleInitCodemirror();
                                    var Q = O.$el.querySelector(".cm-scroller");
                        ...
                        handleDownloadLogFile: function() {
                            var O = this,
                                Q = this.$message.loading("下载中...", 0);
                            this.downloading = !0, Y.Z.getLogFile(this.logLines).then((function(O) {
                                var Q = new Blob([O.data]),
                                    i = document.createElement("a"),
                                    $ = window.URL.createObjectURL(Q);
                                i.href = $, i.download = "halo-log-" + (0, T._)(new Date, "YYYY-MM-DD-HH-mm-ss") + ".log", document.body.appendChild(i), i.click(), document.body.removeChild(i), window.URL.revokeObjectURL($)
                            })).catch((function() {
                                O.$message.error("下载失败！")
                            })).finally((function() {
                                setTimeout((function() {
                                    O.downloading = !1, Q()
                                }), 400)
