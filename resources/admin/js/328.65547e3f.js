        ...
        70328: function(M, L, t) {
            ...
            var i = function() {
                    ...
                    return t("a-row", {
                        ...
                        staticClass: "card-container animated fadeIn"
                    }, [t("a-card", {
                        staticStyle: {
                        ...
                        model: {
                            value: M.installationMode,
                            callback: function(L) {
                                M.installationMode = L
                            },
                            expression: "installationMode"
                        }
                    }, [t("a-radio-button", {
                        attrs: {
                            value: "new"
                        }
                    }, [M._v(" 全新安装")]), t("a-radio-button", {
                        attrs: {
                            value: "import"
                        }
                    }, [M._v(" 数据导入")])], 1)], 1), t("a-form-model", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: M.isInstallMode,
                            expression: "isInstallMode"
                        }],
                        ref: "installationForm",
                        staticClass: "installationForm animated fadeIn",
                        attrs: {
                            model: M.form.model,
                            rules: M.form.rules,
                            layout: "horizontal"
                    ...
                    }, [M._v(" 管理员信息")]), t("a-form-model-item", {
                        attrs: {
                            prop: "username"
                        }
                    }, [t("a-input", {
                        ...
                        model: {
                            value: M.form.model.username,
                            callback: function(L) {
                                M.$set(M.form.model, "username", L)
                            },
                        ...
                        model: {
                            value: M.form.model.nickname,
                            callback: function(L) {
                                M.$set(M.form.model, "nickname", L)
                            },
                            expression: "form.model.nickname"
                        }
                    }, [t("a-icon", {
                        staticStyle: {
                            color: "rgba(0, 0, 0, 0.25)"
                        ...
                        model: {
                            value: M.form.model.email,
                            callback: function(L) {
                                M.$set(M.form.model, "email", L)
                            },
                            expression: "form.model.email"
                        }
                    }, [t("a-icon", {
                        staticStyle: {
                            color: "rgba(0, 0, 0, 0.25)"
                        ...
                        model: {
                            value: M.form.model.password,
                            callback: function(L) {
                                M.$set(M.form.model, "password", L)
                            },
                        ...
                        model: {
                            value: M.form.model.confirmPassword,
                            callback: function(L) {
                                M.$set(M.form.model, "confirmPassword", L)
                            },
                            expression: "form.model.confirmPassword"
                        }
                    }, [t("a-icon", {
                        staticStyle: {
                            color: "rgba(0, 0, 0, 0.25)"
                        ...
                        model: {
                            value: M.form.model.url,
                            callback: function(L) {
                                M.$set(M.form.model, "url", L)
                            },
                        ...
                        model: {
                            value: M.form.model.title,
                            callback: function(L) {
                                M.$set(M.form.model, "title", L)
                            },
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: M.isImportMode,
                            expression: "isImportMode"
                        }],
                        ...
                        attrs: {
                            ...
                            multiple: !1,
                            uploadHandler: M.onImportUpload,
                            label: "拖拽或点击选择数据文件<br>请确认是否为 Sonic 后台导出的文件。",
                            name: "file"
                        }
                    })], 1), t("div", {
                        staticClass: "mt-8"
                    }, [M.isInstallMode ? t("ReactiveButton", {
                        attrs: {
                            errored: M.form.installErrored,
                            loading: M.form.installing,
                            block: "",
                            erroredText: "安装失败",
                            icon: "check",
                            loadedText: "安装成功",
                        ...
                        on: {
                            callback: M.handleInstallCallback,
                            click: M.handleInstall
                        }
                    }) : M._e(), M.isImportMode ? t("ReactiveButton", {
                        attrs: {
                            errored: M.form.importErrored,
                            loading: M.form.importing,
                            block: "",
                            erroredText: "导入失败",
                            icon: "import",
                            loadedText: "导入成功",
                        ...
                        on: {
                            callback: M.handleImportCallback,
                            click: M.handleImport
                        }
                    }) : M._e()], 1)], 1)], 1)])], 1)
                },
                s = [],
                j = t(44729),
                e = (t(87591), t(31875), t(30535), t(85018), t(88696)),
                o = t(98906),
                a = {
                    data: function() {
                        var M = this,
                            L = function(L, t, i) {
                                t !== M.form.model.password ? i(new Error("确认密码与所输入的密码不一致")) : i()
                            };
                        return {
                    ...
                    computed: {
                        isInstallMode: function() {
                            return "new" === this.installationMode
                        },
                        isImportMode: function() {
                            return "import" === this.installationMode
                        }
                    },
                    methods: (0, j.Z)((0, j.Z)({}, (0, o.nv)(["installCleanToken", "fetchIsInstalled"])), {}, {
                        handleInstall: function() {
                            var M = this;
                            this.$refs.installationForm.validate((function(L) {
                                L && (M.form.installing = !0, M.installCleanToken(M.form.model).then((function(L) {
                                    M.$log.debug("Installation response", L)
                                })).catch((function() {
                                    M.form.installErrored = !0
                                })).finally((function() {
                                    setTimeout((function() {
                                        M.form.installing = !1
                                    }), 400), M.fetchIsInstalled()
                                })))
                            }))
                        },
                        handleInstallCallback: function() {
                            this.form.installErrored ? this.form.installErrored = !1 : (this.$message.success("安装成功！"), this.$router.push({
                                name: "Login"
                            }))
                        },
                        onImportUpload: function(M) {
                            var L = this;
                            return this.$log.debug("Selected data", M), this.form.importData = M, new Promise((function(M) {
                                L.$log.debug("Handle uploading"), M()
                            }))
                        },
                        handleImport: function() {
                            var M = this;
                            this.form.importData ? (this.form.importing = !0, e.Z.migration.migrate(this.form.importData).then((function() {
                                M.$log.debug("Migrated successfully")
                            })).catch((function() {
                                M.form.importErrored = !0
                            })).finally((function() {
                                setTimeout((function() {
                                    M.form.importing = !1
                                }), 400), M.fetchIsInstalled()
                        ...
                        handleImportCallback: function() {
                            this.form.importErrored ? this.form.importErrored = !1 : (this.$message.success("导入成功！"), this.$router.replace({
                                name: "Login"
                            }))
                        }
                    })
                ...
                l = a,
                u = t(19577),
                N = (0, u.Z)(l, i, s, !1, null, "4d92cd43", null),
                r = N.exports
        }
    }
]);