            ...
            var r = function() {
                    ...
                    return a("a-modal", {
                        ...
                        on: {
                            ...
                            confirm: e.handleSelectSheetThumbnail
                        }
                    })], 1)
                },
                o = [],
                l = a(96365),
                n = a(44729),
                s = (a(70315), a(41479), a(87591), a(30535), a(85018), a(31875), a(18482), a(86381), a(40448)),
                i = a(94238),
                m = a(32609),
                c = a(73511),
                u = a.n(c),
                ...
                p = {
                    ...
                    computed: (0, n.Z)((0, n.Z)({}, (0, d.Se)(["options"])), {}, {
                        modalVisible: {
                            get: function() {
                                return this.visible
                            },
                        ...
                        fullPath: function() {
                            var e = this.options,
                                t = e.sheet_permalink_type,
                                a = e.blog_url,
                                r = e.sheet_prefix,
                                o = e.path_suffix,
                                l = void 0 === o ? "" : o,
                                n = this.form.model.slug,
                                s = void 0 === n ? "{slug}" : n;
                            switch (t) {
                                case "SECONDARY":
                                    return "".concat(a, "/").concat(r, "/").concat(s).concat(l);
                                case "ROOT":
                        ...
                        draftSaveVisible: function() {
                            var e = this.form,
                                t = e.draftSaving,
                                a = e.publishing;
                            return (this.form.model.status !== f.Zi.DRAFT.value || !this.hasId || t) && !a
                        },
                        publishVisible: function() {
                            var e = this.form,
                                t = e.draftSaving,
                                a = e.publishing;
                            return (this.form.model.status === f.Zi.DRAFT.value && this.hasId || a) && !t
                        }
                    }),
                    watch: {
                        modalVisible: function(e) {
                            e && (this.form.model = Object.assign({}, this.sheet), this.form.model.slug || this.form.model.id || this.handleGenerateSlug())
                        },
                        sheet: {
                            deep: !0,
                            handler: function(e) {
                    ...
                    methods: {
                                ...
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        ...
                                        case 3:
                                            ...
                                            return t.next = 8, h.Z.sheet.update(e.form.model.id, e.form.model);
                                        case 8:
                                            t.next = 12;
                                            break;
                                        case 10:
                                            return t.next = 12, h.Z.sheet.create(e.form.model);
                                        case 12:
                                            t.next = 18;
                                            break;
                                        case 14:
                        ...
                        handleSave: function() {
                            ...
                            return (0, l.Z)(regeneratorRuntime.mark((function t() {
                                ...
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            return t.prev = 0, e.form.saving = !0, a = e.form.model.status, a || (e.form.model.status = e.sheetStatuses.PUBLISHED.value), t.next = 6, e.handleCreateOrUpdate();
                                        case 6:
                                            t.next = 12;
                                            break;
                                        case 8:
                                            t.prev = 8, t.t0 = t["catch"](0), e.form.saveErrored = !0, e.$log.error("Failed to save sheet", t.t0);
                                        case 12:
                        ...
                        handlePublish: function() {
                            ...
                            return (0, l.Z)(regeneratorRuntime.mark((function t() {
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            return t.prev = 0, e.form.publishing = !0, e.form.model.status = e.sheetStatuses.PUBLISHED.value, t.next = 5, e.handleCreateOrUpdate();
                                        case 5:
                                            t.next = 11;
                                            break;
                                        case 7:
                                            t.prev = 7, t.t0 = t["catch"](0), e.form.publishErrored = !0, e.$log.error("Failed to publish sheet", t.t0);
                                        case 11:
                        ...
                        handleSaveDraft: function() {
                            ...
                            return (0, l.Z)(regeneratorRuntime.mark((function t() {
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            return t.prev = 0, e.form.draftSaving = !0, e.form.model.status = e.sheetStatuses.DRAFT.value, t.next = 5, e.handleCreateOrUpdate();
                                        case 5:
                                            t.next = 11;
                                            break;
                                        case 7:
                                            t.prev = 7, t.t0 = t["catch"](0), e.form.draftSaveErrored = !0, e.$log.error("Failed to save draft sheet", t.t0);
                                        case 11:
                                            return t.prev = 11, setTimeout((function() {
                        ...
                        handleListCustomTemplates: function() {
                            ...
                            return (0, l.Z)(regeneratorRuntime.mark((function t() {
                                ...
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            return t.prev = 0, t.next = 3, h.Z.theme.listCustomSheetTemplates();
                                        case 3:
                        ...
                        handleGenerateSlug: function() {
                            if (this.form.model.title && u().isSupported()) {
                                var e, t = "",
                                    a = u().parse(this.form.model.title.replace(/\s+/g, "").toLowerCase());
                        ...
                        handleSelectSheetThumbnail: function(e) {
                            var t = e.raw;
                ...
                b = p,
                v = a(19577),
                g = (0, v.Z)(b, r, o, !1, null, null, null),
                S = g.exports
        }
    }
]);