...
(self["webpackChunkhalo_admin"] = self["webpackChunkhalo_admin"] || []).push([
    [154], {
        43154: function(e, t) {
            ...
            function f(e) {
                return "object" === n(e) && e.model ? e.model : ("#" !== e.slice(0, 1) || 4 !== e.length && 7 !== e.length) && ("#" !== e.slice(0, 1) || 6 !== e.length && 9 !== e.length) ? "RGBA" === e.slice(0, 4).toUpperCase() || "RGB" === e.slice(0, 3).toUpperCase() ? "rgb" : ("HSLA" === e.slice(0, 4).toUpperCase() || "HSL" === e.slice(0, 3).toUpperCase()) && "hsl" : "hex"
            }
            ...
            var y = function() {
                    function e(t) {
                        var n = this;
                        r(this, e), this.invalid = !this.validate(t), this.invalid || Object.keys(t).forEach((function(e) {
                            n[e] = t[e]
                        })), this.init()
                    }
                    return a(e, [{
                ...
                C = function(e) {
                    function t() {
                        return r(this, t), c(this, o(t).apply(this, arguments))
                    }
                    return s(t, e), a(t, [{
                        key: "validate",
                        value: function(e) {
                            if (!d(o(t.prototype), "validate", this).call(this, e)) return !1;
                            var n = m(0, 255);
                        ...
                        key: "init",
                        value: function() {
                            this.model = "rgb", this.alpha = b(this.alpha) ? this.alpha : 1
                        }
                    }, {
                        key: "toString",
                        value: function() {
                            return this.invalid ? "Invalid Color" : m(0, .999)(this.alpha) ? "rgba(".concat(this.red, ",").concat(this.green, ",").concat(this.blue, ",").concat(this.alpha, ")") : "rgb(".concat(this.red, ",").concat(this.green, ",").concat(this.blue, ")")
                        }
                    }]), t
                }(y),
                x = function(e) {
                    ...
                    return s(t, e), a(t, [{
                        ...
                        value: function(e) {
                            if (!d(o(t.prototype), "validate", this).call(this, e)) return !1;
                            var n = m(0, 100);
                            return m(0, 360)(e.hue) && n(e.lum) && n(e.sat)
                        }
                    }, {
                        key: "init",
                        value: function() {
                            this.model = "hsl", this.alpha = b(this.alpha) ? this.alpha : 1
                        }
                    }, {
                        key: "toString",
                        value: function() {
                            return this.invalid ? "Invalid Color" : m(0, .999)(this.alpha) ? "hsla(".concat(this.hue, ",").concat(this.sat, "%,").concat(this.lum, "%,").concat(this.alpha, ")") : "hsl(".concat(this.hue, ",").concat(this.sat, "%,").concat(this.lum, "%)")
                        }
                    }]), t
                }(y),
                _ = function(e) {
                    ...
                    return s(t, e), a(t, [{
                        key: "validate",
                        value: function(e) {
                            return !!d(o(t.prototype), "validate", this).call(this, e) && /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test("#".concat(e.red).concat(e.green).concat(e.blue))
                        }
                    }, {
                        key: "init",
                        value: function() {
                        ...
                        key: "toString",
                        value: function() {
                            return this.invalid ? "Invalid Color" : m(0, .999)(p(this.alpha) / 255) ? "#".concat(this.red).concat(this.green).concat(this.blue).concat(this.alpha) : "#".concat(this.red).concat(this.green).concat(this.blue)
                        }
                    }]), t
                }(y),
                w = Object.freeze({
            ...
            function S(e) {
                ...
                return !t || t.length < 4 ? new C : new C({
                    red: Number(t[1]),
                    green: Number(t[2]),
                    blue: Number(t[3]),
                    alpha: Number(t[4])
            ...
            function k(e) {
                ...
                return 5 !== e.length && 4 !== e.length || !t.test(e) || (e = e.replace(t, (function(e, t, n, r, i) {
                    return "#".concat(t).concat(t).concat(n).concat(n).concat(r).concat(r).concat(i ? "".concat(i).concat(i) : "")
                }))), e
            }
            ...
            function M(e) {
                if ("object" === n(e)) return e;
                var t = k(e),
                    r = t.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})*/i);
                return !r || r.length < 4 ? new _ : new _({
                    hex: t,
                    red: r[1],
                    green: r[2],
                    blue: r[3],
            ...
            function L(e) {
                ...
                return !t || t.length < 4 ? new x : new x({
                    hue: Number(t[1]),
                    sat: Number(t[2]),
                    lum: Number(t[3]),
                    alpha: Number(t[4])
            ...
            function E(e) {
                var t = f(e);
                return "rgb" === t ? !S(e).invalid : "hex" === t ? !M(e).invalid : "hsl" === t && !L(e).invalid
            }
            ...
            function P(e) {
                if (!e) return new _;
                e = S(e);
                var t = [H(e.red), H(e.green), H(e.blue), e.alpha ? H(255 * e.alpha) : null],
                    n = t[0],
                    r = t[1],
                    i = t[2],
                    a = t[3];
            ...
            function A(e) {
                if (!e) return new x;
                e = S(e);
                var t = [e.red / 255, e.green / 255, e.blue / 255, e.alpha],
                    n = t[0],
                    r = t[1],
                    i = t[2],
                    a = t[3],
                    ...
                    u = Math.min(n, r, i),
                    c = Math.max(n, r, i);
                return l = (u + c) / 2, u !== c && (o = l > .5 ? (c - u) / (2 - c - u) : (c - u) / (c + u)), n >= c && u !== c && (s = (r - i) / (c - u) * 60), r >= c && u !== c && (s = 60 * (2 + (i - n) / (c - u))), i >= c && u !== c && (s = 60 * (4 + (n - r) / (c - u))), s = s < 0 ? Math.floor(s + 360) : Math.floor(s), o = Math.floor(100 * o), l = Math.floor(100 * l), new x({
                    hue: s,
                    sat: o,
                    lum: l,
                    alpha: a
            ...
            function N(e) {
                ...
                return new C({
                    ...
                    green: p(r),
                    blue: p(i),
                    alpha: void 0 === a ? 1 : Number((p(a) / 255).toFixed(2))
                })
            }
            ...
            function $(e) {
                if (!e) return new C;
                e = L(e);
                var t = [e.hue / 360, e.sat / 100, e.lum / 100, e.alpha],
                    n = t[0],
                    r = t[1],
                    i = t[2],
                    a = t[3],
                    ...
                    o = 0,
                    l = 0;
                if (0 === r && (s = o = l = R(255 * i)), 0 !== r) {
                    var u = i >= 50 ? i + r - i * r : i * (1 + r),
                        c = 2 * i - u,
                        h = function(e) {
                            return e < 0 && (e += 1), e > 1 && (e -= 1), e < 1 / 6 ? c + 6 * (u - c) * e : e < .5 ? u : e < 2 / 3 ? c + (u - c) * (2 / 3 - e) * 6 : c
                        };
                    s = R(255 * h(n + 1 / 3)), o = R(255 * h(n)), l = R(255 * h(n - 1 / 3))
                }
                return new C({
                    red: s,
                    green: o,
            ...
            function B(e) {
                var t = f(e);
                return "hex" === t ? N(e) : "hsl" === t ? $(e) : "rgb" === t && "string" === typeof e ? S(e) : "rgb" === t && "object" === n(e) ? e : new C
            }

            function j(e) {
                var t = f(e);
                return "hex" === t ? V(e) : "rgb" === t ? A(e) : "hsl" === t && "string" === typeof e ? L(e) : "hsl" === t && "object" === n(e) ? e : new x
            }

            function I(e) {
                var t = f(e);
                return "rgb" === t ? P(e) : "hsl" === t ? O(e) : "hex" === t && "string" === typeof e ? M(e) : "hex" === t && "object" === n(e) ? e : new _
            }
            ...
            var Y = {
                    ...
                    methods: {
                        init: function() {
                            var e = this;
                            this.$emitInputEvent = D((function() {
                        ...
                        getStepValue: function(e) {
                            var t = Z(e),
                                ...
                                a = i * this.step + this.min;
                            return this.decimalsCount ? Number(a.toFixed(this.decimalsCount)) : a
                        },
                        ...
                        getHandleColor: function(e) {
                            for (var t = this, n = this.gradient.length - 1, r = e, i = 1; i <= n; i++)
                                if (r >= (i - 1) / n && r <= i / n) {
                                    var a = (r - (i - 1) / n) / (1 / n);
                                    return F(t.gradient[i - 1], t.gradient[i], a)
                                } return "rgb(0, 0, 0)"
                        },
                        ...
                        updateValue: function(e, t) {
                            ...
                            void 0 === t && (t = !1), window.requestAnimationFrame((function() {
                                ...
                                if (n.fill && (n.fill.translate = i * n.width, n.fill.scale = 1 - i), n.values[n.activeHandle] = r, n.handles[n.activeHandle].value = r, n.handles[n.activeHandle].position = i * n.width, n.currentValue = r, n.$refs.input.value = n.currentValue, n.gradient) {
            ...
            function ie(e, t, n, r, i, a, s, o) {
                var l = ("function" === typeof n ? n.options : n) || {};
                return l.__file = "/mnt/c/Users/Abdelrahman/Projects/verte/src/components/Slider.vue", l.render || (l.render = e.render, l.staticRenderFns = e.staticRenderFns, l._compiled = !0, i && (l.functional = !0)), l._scopeId = r, l
            }

            function ae() {
                var e = document.head || document.getElementsByTagName("head")[0],
                    t = ae.styles || (ae.styles = {}),
                ...
                return function(r, i) {
                    if (!document.querySelector('style[data-vue-ssr-id~="' + r + '"]')) {
                        ...
                        if (!s.ids.includes(r)) {
                            var o = i.source,
                                l = s.ids.length;
                            if (s.ids.push(r), n && (s.element = s.element || document.querySelector("style[data-group=" + a + "]")), !s.element) {
                                var u = s.element = document.createElement("style");
                                u.type = "text/css", i.media && u.setAttribute("media", i.media), n && (u.setAttribute("data-group", a), u.setAttribute("data-next-index", "0")), e.appendChild(u)
                            }
                            if (n && (l = parseInt(s.element.getAttribute("data-next-index")), s.element.setAttribute("data-next-index", l + 1)), s.element.styleSheet) s.parts.push(o), s.element.styleSheet.cssText = s.parts.filter(Boolean).join("\n");
                            else {
                                var c = document.createTextNode(o),
                                    h = s.element.childNodes;
                                h[l] && s.element.removeChild(h[l]), h.length ? s.element.insertBefore(c, h[l]) : s.element.appendChild(c)
                            }
                        }
                    }
                }
                    ...
                    methods: {
                        ...
                        handleValue: function(e, t) {
                            ...
                            if (this.currentColor = j(e), this.preventEcho = !0, "wheel" === this.mode) {
                                var a = (100 - this.currentColor.lum) * (this.diameter / 200),
                                    s = this.diameter / 2,
                                    o = G(a, this.currentColor.hue / 360);
                                this.cursor = {
                                    x: o.x + s,
                                    y: o.y + s
                        ...
                        updateCursorPosition: function(e) {
                            var t = e.x,
                                ...
                                o = r.height,
                                l = {
                                    x: Math.min(Math.max(t - i, 0), s),
                                    y: Math.min(Math.max(n - a, 0), o)
                                };
                        ...
                        updateWheelColors: function() {
                            ...
                            if (this.circle) {
                                ...
                                for (var l = 0; l < 360; l += 1) {
                                    var u = e.ctx.createRadialGradient(i, a, 0, i, a, s),
                                        c = (l - 2) * Math.PI / 180,
                                        h = (l + 2) * Math.PI / 180;
                                    e.ctx.beginPath(), e.ctx.moveTo(i, a), e.ctx.arc(i, a, s, c, h), e.ctx.closePath(), u.addColorStop(0, "hsl(" + l + ", " + o + "%, 100%)"), u.addColorStop(.5, "hsl(" + l + ", " + o + "%, 50%)"), u.addColorStop(1, "hsl(" + l + ", " + o + "%, 0%)"), e.ctx.fillStyle = u, e.ctx.fill()
                                }
                            }
                        },
                        updateSquareColors: function() {
                            ...
                            r.addColorStop(0, "hsl(0, 0%, 50%)"), r.addColorStop(1, "hsla(0, 0%, 50%, 0)"), this.ctx.fillStyle = r, this.ctx.fillRect(0, 0, t, n);
                        ...
                        getCanvasColor: function() {
                            var e = this.cursor,
                                ...
                                a = 0;
                            if ("wheel" === this.mode) {
                                var s = this.diameter / 2,
                                    o = t - s,
                                    l = -1 * (n - s),
                                    u = z(o, l),
                                    c = u.r,
                                    h = u.theta;
                                i = 100 * (s - c) / s, a = ~Math.sign(h) ? 360 - h : -h, r = this.currentSat
                            }
                            if ("square" === this.mode) {
                                var d = this.pickerRect,
                                    f = d.width,
                                    p = d.height;
                                r = 100 * t / f, i = 100 - 100 * n / p, a = this.currentHue
                            }
                            return new w.HslColor({
                                alpha: this.alpha,
                                hue: Math.round(a),
                                sat: Math.round(r),
                                lum: Math.round(i)
                        ...
                        handleSelect: function(e) {
                            var t = this;
                            e.preventDefault(), this.pickerRect = this.$refs.canvas.getBoundingClientRect(), this.updateCursorPosition(Z(e));
                            var n = function(e) {
                                    window.requestAnimationFrame((function() {
                                        t.updateCursorPosition(Z(e))
                                    }))
                                },
                                r = function() {
                                    document.removeEventListener("mousemove", n), document.removeEventListener("touchmove", n), document.removeEventListener("mouseup", r), document.removeEventListener("touchend", r)
                                };
                            document.addEventListener("mousemove", n), document.addEventListener("touchmove", n), document.addEventListener("mouseup", r), document.addEventListener("touchend", r)
                        }
                    },
                    mounted: function() {
                        var e = this;
            ...
            function me(e, t, n, r, i, a, s, o) {
                var l = ("function" === typeof n ? n.options : n) || {};
                return l.__file = "/mnt/c/Users/Abdelrahman/Projects/verte/src/components/Picker.vue", l.render || (l.render = e.render, l.staticRenderFns = e.staticRenderFns, l._compiled = !0, i && (l.functional = !0)), l._scopeId = r, l
            }

            function ve() {
                var e = document.head || document.getElementsByTagName("head")[0],
                    t = ve.styles || (ve.styles = {}),
                    n = "undefined" !== typeof navigator && /msie [6-9]\\b/.test(navigator.userAgent.toLowerCase());
                return function(r, i) {
                    if (!document.querySelector('style[data-vue-ssr-id~="' + r + '"]')) {
                        var a = n ? i.media || "default" : r,
            ...
            function xe(e, t) {
                ...
                return ge = e, be = new ge({
                    data: function() {
                        return {
                            recentColors: n || T(6, q)
                        }
                    },
                    methods: {
                        addRecentColor: function(e) {
                            this.recentColors.includes(e) || (this.recentColors.length >= Ce && this.recentColors.pop(), this.recentColors.unshift(e), r && r(this.recentColors))
                        }
                    }
                }), be
            }
            var _e = {
                    ...
                    props: {
                        picker: {
                            type: String,
                            default: "square",
                            validator: X("picker", ["wheel", "square"])
                        },
                        value: {
                            type: String,
                            default: "#000"
                        ...
                        model: {
                            type: String,
                            default: "hsl",
                            validator: X("model", ["rgb", "hex", "hsl"])
                        },
                        display: {
                            type: String,
                            default: "picker",
                            validator: X("display", ["picker", "widget"])
                        },
                        menuPosition: {
                            type: String,
                            default: "bottom",
                            validator: X("menuPosition", ["top", "bottom", "left", "right", "center"])
                        },
                        showHistory: {
                            type: Boolean,
                            default: !0
                    ...
                    watch: {
                        ...
                        rgb: {
                            handler: function(e) {
                                this.hex = I(e.toString()), this.$emit("input", this.currentColor)
                            },
                            deep: !0
                        },
                    ...
                    beforeCreate: function() {
                        xe(this.$options._base)
                    },
                    install: function(e, t) {
                        xe(e, t), e.component("Verte", this)
                    },
                    created: function() {
                    ...
                    methods: {
                        selectColor: function(e, t) {
                            void 0 === t && (t = !1), E(e) && (this.rgb = B(e), this.hex = I(e), this.hsl = j(e), t || this.$emit("input", this.currentColor))
                        },
                        ...
                        handleMenuDrag: function(e) {
                            ...
                            if (2 !== e.button) {
                                ...
                                var n = Object.assign({}, this.delta),
                                    ...
                                    a = function() {
                                        document.removeEventListener("mousemove", i), document.removeEventListener("mouseup", a), document.removeEventListener("touchmove", i), document.removeEventListener("touchup", a)
                                    };
                                document.addEventListener("mousemove", i), document.addEventListener("mouseup", a), document.addEventListener("touchmove", i), document.addEventListener("touchup", a)
                            }
                        },
                        submit: function() {
                        ...
                        addColorToHistory: function(e) {
                            if (this.colorHistory) return this.internalColorHistory.length >= Ce && this.internalColorHistory.pop(), this.internalColorHistory.unshift(e), void this.$emit("update:colorHistory", this.internalColorHistory);
                        ...
                        openMenu: function() {
                            ...
                            this.isMenuActive = !0, this.closeCallback = function(t) {
                                U(t.target, e.$refs.menu) || U(t.target, e.$refs.guide) || e.closeMenu()
                ...
                Se = function() {
                    ...
                    }, [n("title", [e._v("Close Icon")]), n("path", {
                        attrs: {
                            d: "M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z"
                        }
                    })])]), e.draggable && !e.menuOnly ? n("div", {
            ...
            function Pe(e, t, n, r, i, a, s, o) {
                var l = ("function" === typeof n ? n.options : n) || {};
                return l.__file = "/mnt/c/Users/Abdelrahman/Projects/verte/src/components/Verte.vue", l.render || (l.render = e.render, l.staticRenderFns = e.staticRenderFns, l._compiled = !0, i && (l.functional = !0)), l._scopeId = r, l
            }
