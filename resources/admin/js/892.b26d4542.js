        ...
        86892: function(t, e, n) {
            ...
            var a = function() {
                    ...
                    return n("page-view", [n("a-row", [n("a-col", {
                        ...
                        slot: "title"
                    }, [t._v(" 环境信息 "), n("a-button", {
                        staticClass: "!p-0",
                        attrs: {
                            type: "link"
                        },
                        on: {
                            click: t.handleCopyEnvironments
                        }
                    }, [n("a-icon", {
                        attrs: {
                            type: "copy"
                        ...
                        slot: "content"
                    }, [n("p", [t._v(t._s(t.versionMessage))]), n("a-button", {
                        attrs: {
                            type: "dashed"
                        },
                        on: {
                            click: t.handleShowVersionContent
                        }
                        ...
                        staticClass: "p-0 m-0 list-none"
                    }, [n("li", [t._v("版本：" + t._s(t.environments.version))]), n("li", [t._v("数据库：" + t._s(t.environments.database))]), n("li", [t._v("运行模式：" + t._s(t.environments.mode))]), n("li", [t._v("启用主题：" + t._s(t.activatedTheme.name))]), n("li", [t._v("启动时间：" + t._s(t._f("moment")(t.environments.startTime)))])]), n("a", {
                        staticClass: "mr-3",
                        attrs: {
                            href: "https://github.com/go-sonic/sonic",
                            target: "_blank"
                        }
                    }, [t._v("官网 "), n("a-icon", {
                        attrs: {
                        ...
                        staticClass: "mr-3",
                        attrs: {
                            href: "https://github.com/go-sonic",
                            target: "_blank"
                        }
                    }, [t._v("开源组织 "), n("a-icon", {
                        attrs: {
                    ...
                    }, [t._v(" 感谢Halo，Sonic 的前端项目 Fork自Halo. "), n("a", {
                        staticClass: "mr-3",
                        attrs: {
                            href: "https://halo.run",
                            target: "_blank"
                        }
                    }, [t._v("Halo官网 "), n("a-icon", {
                        attrs: {
                            type: "link"
                        }
                    })], 1)]), n("a-card", {
                        ...
                        return n("a", {
                            ...
                            attrs: {
                                alt: e.login,
                                src: t._f("webpAvatarConvert")(e.avatar_url),
                                size: "large"
                            }
                        })], 1)], 1)
                    })), 0)], 1)], 1), n("a-col", {
                        ...
                        domProps: {
                            innerHTML: t._s(t.versionContent)
                        }
                    })])], 1)
                },
                r = [],
                i = n(96365),
                o = (n(70315), n(41479), n(21082), n(31875), n(30535), n(85018), n(96339), n(88696)),
                s = n(10299),
                c = n.n(s),
                l = n(45311),
                u = n(81993),
                ...
                d = {
                    ...
                    methods: {
                            ...
                            return (0, i.Z)(regeneratorRuntime.mark((function e() {
                                ...
                                return regeneratorRuntime.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2, o.Z.getEnvironment();
                                        case 2:
                        ...
                        handleGetActivatedTheme: function() {
                            ...
                            return (0, i.Z)(regeneratorRuntime.mark((function e() {
                                ...
                                return regeneratorRuntime.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2, o.Z.theme.getActivatedTheme();
                                        case 2:
                        ...
                        fetchContributors: function() {
                            var t = this;
                            t.contributorsLoading = !0, h.get("/repos/go-sonic/sonic/contributors?per_page=100").then((function(e) {
                        ...
                        checkServerUpdate: function() {
                            var t = this,
                                ...
                                n = this;
                            n.checking = !0, h.get("/repos/go-sonic/sonic/releases/latest").then((function(a) {
                                var r = a.data;
                                if (n.latestData = r, !r.draft && !r.prerelease) {
                                    var i = n.calculateIntValue(n.environments.version),
                                        o = n.calculateIntValue(r.name);
                                    if (i >= o) n.isLatest = !0;
                                    else {
                                        var s = "新版本提醒",
                                            c = "检测到 Sonic 新版本：" + r.name + "，点击下方按钮查看最新版本。";
                                        n.$notification.open({
                                            message: s,
                                            description: c,
                                            icon: e("a-icon", {
                ...
                p = d,
                v = n(19577),
                m = (0, v.Z)(p, a, r, !1, null, null, null),
                g = m.exports
        }
    }
]);