...
func (a *AdminHandler) IsInstalled(ctx *fiber.Ctx) (interface{}, error) {
	return a.OptionService.GetOrByDefaultWithErr(ctx.Context(), property.IsInstalled, false)
}
...
func (a *AdminHandler) AuthPreCheck(ctx *fiber.Ctx) (interface{}, error) {
	...
	user, err := a.AdminService.Authenticate(ctx.Context(), loginParam)
	if err != nil {
		return nil, err
	}
...
func (a *AdminHandler) SendResetCode(ctx *fiber.Ctx) (interface{}, error) {
	...
	return nil, a.AdminService.SendResetPasswordCode(ctx.Context(), resetPasswordParam)
}
...
func (a *AdminHandler) RefreshToken(ctx *fiber.Ctx) (interface{}, error) {
	...
	return a.AdminService.RefreshToken(ctx.Context(), refreshToken)
}

func (a *AdminHandler) GetEnvironments(ctx *fiber.Ctx) (interface{}, error) {
	return a.AdminService.GetEnvironments(ctx.Context()), nil
}
...
func (a *AdminHandler) GetLogFiles(ctx *fiber.Ctx) (interface{}, error) {
	...
	return a.AdminService.GetLogFiles(ctx.Context(), lines)
}
