...
func (p *PostHandler) ListPosts(ctx *fiber.Ctx) (interface{}, error) {
	...
	err := binding.CustomFormBinding.Bind(ctx.Request(), &postQuery)
	if err != nil {
	...
	posts, totalCount, err := p.PostService.Page(ctx.Context(), postQuery)
	if err != nil {
		return nil, err
	}
	if postQuery.More == nil || *postQuery.More {
		postVOs, err := p.PostAssembler.ConvertToListVO(ctx.Context(), posts)
		return dto.NewPage(postVOs, totalCount, postQuery.Page), err
	}
	postDTOs := make([]*dto.Post, 0)
	for _, post := range posts {
		postDTO, err := p.PostAssembler.ConvertToSimpleDTO(ctx.Context(), post)
		if err != nil {
			return nil, err
		}
...
func (p *PostHandler) ListLatestPosts(ctx *fiber.Ctx) (interface{}, error) {
	...
	posts, _, err := p.PostService.Page(ctx.Context(), postQuery)
	if err != nil {
		return nil, err
	}
	...
	for _, post := range posts {
		postMinimal, err := p.PostAssembler.ConvertToMinimalDTO(ctx.Context(), post)
		if err != nil {
			return nil, err
		}
...
func (p *PostHandler) GetByPostID(ctx *fiber.Ctx) (interface{}, error) {
	...
	post, err := p.PostService.GetByPostID(ctx.Context(), int32(postID))
	if err != nil {
		return nil, err
	}
	postDetailVO, err := p.PostAssembler.ConvertToDetailVO(ctx.Context(), post)
	if err != nil {
		return nil, err
	}
...
func (p *PostHandler) CreatePost(ctx *fiber.Ctx) (interface{}, error) {
	...
	post, err := p.PostService.Create(ctx.Context(), &postParam)
	if err != nil {
		return nil, err
	}
	return p.PostAssembler.ConvertToDetailVO(ctx.Context(), post)
}
...
func (p *PostHandler) UpdatePost(ctx *fiber.Ctx) (interface{}, error) {
	...
	postDetailVO, err := p.PostService.Update(ctx.Context(), int32(postID), &postParam)
	if err != nil {
		return nil, err
	}
	return postDetailVO, nil
...
func (p *PostHandler) UpdatePostStatus(ctx *fiber.Ctx) (interface{}, error) {
	...
	post, err := p.PostService.UpdateStatus(ctx.Context(), int32(postID), status)
	if err != nil {
		return nil, err
	}
	return p.PostAssembler.ConvertToMinimalDTO(ctx.Context(), post)
}
...
func (p *PostHandler) UpdatePostStatusBatch(ctx *fiber.Ctx) (interface{}, error) {
	...
	return p.PostService.UpdateStatusBatch(ctx.Context(), status, ids)
}
...
func (p *PostHandler) UpdatePostDraft(ctx *fiber.Ctx) (interface{}, error) {
	...
	post, err := p.PostService.UpdateDraftContent(ctx.Context(), postID, postContentParam.Content, postContentParam.OriginalContent)
	if err != nil {
		return nil, err
	}
	return p.PostAssembler.ConvertToDetailDTO(ctx.Context(), post)
}
...
func (p *PostHandler) DeletePost(ctx *fiber.Ctx) (interface{}, error) {
	...
	return nil, p.PostService.Delete(ctx.Context(), postID)
}
...
func (p *PostHandler) DeletePostBatch(ctx *fiber.Ctx) (interface{}, error) {
	...
	return nil, p.PostService.DeleteBatch(ctx.Context(), postIDs)
}
...
func (p *PostHandler) PreviewPost(ctx *fiber.Ctx) error {
	...
	previewPath, err := p.PostService.Preview(ctx.Context(), postID)
	if err != nil {
