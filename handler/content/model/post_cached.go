...
// CachedPostModel 使用缓存的 PostModel
type CachedPostModel struct {
...
// NewCachedPostModel 创建使用缓存的 PostModel
func NewCachedPostModel(
	optionService service.OptionService,
	postService service.PostService,
	themeService service.ThemeService,
	postCategoryService service.PostCategoryService,
...
// Content 获取文章内容（使用缓存）
func (p *CachedPostModel) Content(ctx context.Context, post *entity.Post, token string, model template.Model) (string, error) {
	if post == nil {
...
// List 获取文章列表
func (p *CachedPostModel) List(ctx context.Context, page int, model template.Model) (string, error) {
...
func (p *CachedPostModel) convertToListVOWithCache(
	ctx context.Context,
	posts []*entity.Post,
...
// Archives 获取归档列表
func (p *CachedPostModel) Archives(ctx context.Context, page int, model template.Model) (string, error) {
...
// AdminPreview 管理员预览
func (p *CachedPostModel) AdminPreview(ctx context.Context, post *entity.Post, model template.Model) (string, error) {
	if post == nil {
		return "", xerr.WithStatus(nil, int(xerr.StatusBadRequest)).WithMsg("查询不到文章信息")
	}
