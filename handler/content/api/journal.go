...
func (j *JournalHandler) ListJournal(ctx *fiber.Ctx) (interface{}, error) {
	...
	journals, totalCount, err := j.JournalService.ListJournal(ctx.Context(), journalQuery)
	if err != nil {
		return nil, err
	}
	journalDTOs, err := j.JournalService.ConvertToWithCommentDTOList(ctx.Context(), journals)
	if err != nil {
		return nil, err
	}
...
func (j *JournalHandler) GetJournal(ctx *fiber.Ctx) (interface{}, error) {
	...
	journals, err := j.JournalService.GetByJournalIDs(ctx.Context(), []int32{journalID})
	if err != nil {
		return nil, err
	}
	if len(journals) == 0 {
	...
	journalDTOs, err := j.JournalService.ConvertToWithCommentDTOList(ctx.Context(), []*entity.Journal{journals[journalID]})
	if err != nil {
		return nil, err
	}
...
func (j *JournalHandler) ListTopComment(ctx *fiber.Ctx) (interface{}, error) {
	...
	pageSize := j.OptionService.GetOrByDefault(ctx.Context(), property.CommentPageSize).(int)
	...
	comments, totalCount, err := j.JournalCommentService.Page(ctx.Context(), commentQuery, consts.CommentTypeJournal)
	if err != nil {
		return nil, err
	}
	_ = j.JournalCommentAssembler.ClearSensitiveField(ctx.Context(), comments)
	commenVOs, err := j.JournalCommentAssembler.ConvertToWithHasChildren(ctx.Context(), comments)
	if err != nil {
		return nil, err
	}
...
func (j *JournalHandler) ListChildren(ctx *fiber.Ctx) (interface{}, error) {
	...
	children, err := j.JournalCommentService.GetChildren(ctx.Context(), parentID, journalID, consts.CommentTypeJournal)
	if err != nil {
		return nil, err
	}
	_ = j.JournalCommentAssembler.ClearSensitiveField(ctx.Context(), children)
	return j.JournalCommentAssembler.ConvertToDTOList(ctx.Context(), children)
}
...
func (j *JournalHandler) ListCommentTree(ctx *fiber.Ctx) (interface{}, error) {
	...
	allComments, err := j.JournalCommentService.GetByContentID(ctx.Context(), journalID, consts.CommentTypeJournal, commentQuery.Sort)
	if err != nil {
		return nil, err
	}
	_ = j.JournalCommentAssembler.ClearSensitiveField(ctx.Context(), allComments)
	commentVOs, total, err := j.JournalCommentAssembler.PageConvertToVOs(ctx.Context(), allComments, commentQuery.Page)
	if err != nil {
		return nil, err
	}
...
func (j *JournalHandler) ListComment(ctx *fiber.Ctx) (interface{}, error) {
	...
	comments, total, err := j.JournalCommentService.Page(ctx.Context(), commentQuery, consts.CommentTypeJournal)
	if err != nil {
		return nil, err
	}
	_ = j.JournalCommentAssembler.ClearSensitiveField(ctx.Context(), comments)
	result, err := j.JournalCommentAssembler.ConvertToWithParentVO(ctx.Context(), comments)
	if err != nil {
		return nil, err
	}
...
func (j *JournalHandler) CreateComment(ctx *fiber.Ctx) (interface{}, error) {
	...
	result, err := j.JournalCommentService.CreateBy(ctx.Context(), &p)
	if err != nil {
		return nil, err
	}
	return j.JournalCommentAssembler.ConvertToDTO(ctx.Context(), result)
}
...
func (j *JournalHandler) Like(ctx *fiber.Ctx) (interface{}, error) {
	...
	err = j.JournalService.IncreaseLike(ctx.Context(), journalID)
	if err != nil {
		return nil, err
	}
	return nil, nil
